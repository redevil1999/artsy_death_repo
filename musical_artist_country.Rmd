...
mac_clean_age_century <- mac_clean %>%
  ...
  mutate(years = cut(numeric_birthYear, breaks=c(1814, 1855, 1900, 1950), labels=FALSE)) %>%
...
ggplot( data = graph_english_countries) + 
  ...
  xlab("Countries") + 
  ylab("Average Age") + 
  ggtitle("Average Age for Musical Artists per Country per Interval of Years") + 
  coord_flip() 
  theme(axis.text.x = element_text(angle=90, hjust=1)) 
  
ggsave('ma_country_interval.jpeg')
